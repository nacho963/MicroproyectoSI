    ...
    return [
      {
        ...
        step: [
          {
            description: "Cut the bacon into lardons and saut� until it's lightly cooked."
          },
          {
        ...
        ingredientGroup: [
          {
            ...
            ingredient: [
              ...
              },
              {
                amount: "500",
                unit: "g",
                name: "passata (Italian-style sieved tomato pur�e)"
              },
              {
                name: "cinammon",
                preparation: "ground"
          ...
          },
          {
            ...
            ingredient: [
              ...
              },
              {
                amount: "250",
                unit: "g",
                name: "hard cheese (we used Gruy�re)",
                preparation: "grated"
              },
              {
                name: "nutmeg",
      ...
      },
      {
        ...
        step: [
          ...
          {
            description: "Reduce heat a little, add jalape�o and bell pepper, cook until slightly soft. 3-4 min, do not overcook"
          },
          {
      ...
      },
      {
        ...
        step: [
          ...
          {
            description: "While the base is baking and the sauce simmering, cut the bacon into 5mm lardons and saut� with the mushrooms until almost (but not completely) cooked to your liking."
          },
          {
      ...
      },
      {
        ...
        name: "Garlic mushrooms a la cr�me with lardons and green pepper",
      ...
      },
      {
        ...
        step: [
          ...
          {
            description: "Saut� garlic and onion in a bit of butter."
          },
          {
            description: "Add the livers and saut� on both sides until they have a bit color but are still pink inside. Season with salt and pepper."
          },
          {
      ...
      },
      {
        ...
        forked: "[?tap?d? ??as?t?: ?e????st?? �e??? �e t??a �??? ?????!](https://www.cretangastronomy.gr/2013/04/%CF%87%CF%84%CE%B1%CF%80%CF%8C%CE%B4%CE%B9-%CE%BA%CF%81%CE%B1%CF%83%CE%AC%CF%84%CE%BF-%CE%BE%CE%B5%CF%87%CF%89%CF%81%CE%B9%CF%83%CF%84%CF%8C%CF%82-%CE%BC%CE%B5%CE%B6%CE%AD%CF%82-%CE%BC%CE%B5-%CF%84-2/)",
        ingredientGroup: []
      },
      {
      ...
      },
      {
        ...
        forked: "[Sf?????t? t? ??t??????](https://akispetretzikis.com/el/categories/almyres-pites-tartes/sfoyggato-to-mytilhnio), [Sf?????t? ??t?????? �e ??????????a](https://www.madameginger.com/syntages/syntages-mageirikis/ayga/sfouggato-mutilinis/)"
      },
      {
        ...
        step: [
          ...
          {
            description: "Finely chop the mint and parsley, then saut� until just starting to turn crispy. Set aside."
          },
          {
            description: "Saut� the onion with enough butter or oil until golden"
          },
          {
            description: "Add the garlic and saut� for 1-2 more minutes"
          },
          {
            description: "Add the turmeric and saut� for 2 more minutes"
          },
          {
            description: "Add the beef cubes and saut� until browned on the outside"
          },
          {
            description: "Pour in the beef stock and saut�ed mint and parsley and simmer"
          },
          {
            description: "In a separate pan, saut� the celery until *just* starting to turn brown. Set aside."
          },
          {
            description: "After the stew has been simmering for 1.5 hour, pour in the saut�ed celery and simmer for another 30 minutes. This is done so that the celery doesn�t become too mushy."
          },
          {
